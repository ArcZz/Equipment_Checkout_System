<?php
	...
	if($stmt = mysqli_prepare($link, "INSERT INTO item (name, barcode) VALUES (?, ?)") or die ("prepare error" . mysqli_error($link))){
			
		mysqli_stmt_bind_param($stmt, "ss", $item, $barcode) or die ("bind param" . mysqli_stmt_error($stmt));
